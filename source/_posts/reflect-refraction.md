...
最后，对非偏振光而言，菲涅尔反射率为:$F\_{r} = \frac{r\_{\|}^{2} + r\_{\bot}^{2}}{2}$
...
$$L\_o(\theta\_o,\phi\_o) = \int\_\Omega \delta(cos\theta\_i - cos\theta\_r) \delta(\phi\_o - \phi\_r \pm \pi) L\_i(\theta\_i,\phi\_i)|cos\theta\_i|d\omega\_i = L\_i(\theta\_r,\phi\_r \pm \pi)|cos\theta\_i|$$
